...
for msg in st.session_state.messages:
    with st.chat_message(msg["role"]):
        ...
        if msg["role"] == "assistant":
            ...
            elif "生活状況" in msg["content"] or "生活" in msg["content"]:
                st.caption("例：家族と同居、一人暮らし、入院中、施設入所中 など")
            elif "医療的ケア" in msg["content"] or "医療" in msg["content"]:
...
以下の順番で必ず質問してください。まだ聞いていない項目から次の1つだけ質問します：
...
④ 医療的ケアの有無
   （例：服薬管理、通院同行、インスリン注射、胃ろう、たんの吸引。ない場合も教えてください）
⑤ 行動障害の有無
